          ...
          requiredDuringSchedulingIgnoredDuringExecution:
            ...
            - matchExpressions:
              - operator: In
                ...
                - CloudPermanent
                - CloudStatic
                {{- if or (eq $fullname "csi-node-rbd") (eq $fullname "csi-node-cephfs") (eq $fullname "csi-nfs") (eq $fullname "csi-yadro") (eq $fullname "csi-generic-scsi") (eq $fullname "csi-hpe") (eq $fullname "csi-s3") (eq $fullname "csi-huawei") }}
                - Static
                {{- end }}
